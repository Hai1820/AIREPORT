...
root.configure(background="#a2d2eb")

heading = Label(root, text="Welcome to Automated Attendance System", fg='#d3b1fc', bg="#f1edf7")
heading.configure(font=("Palatino", 35))
heading.pack(fill="x")
...
btn1 = Button(root, text="Add Image to Database", fg="#d3b1fc", bg="#80182A", width=25, height=2, command=clickCapture).pack(pady=(5, 20))
btn2 = Button(root, text="Start Program with Live Camera", fg="#d3b1fc", bg="#80182A", width=25, height=2, command=startProgramWebcam).pack(pady=(0, 20))
